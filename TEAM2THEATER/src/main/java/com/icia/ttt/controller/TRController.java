...
public class TRController {
	...
	// 페이지 이동용
	@RequestMapping(value = "/allTheater", method = RequestMethod.GET)
	public String test() {
		return "TH_Thether";
	}
	
	//trInfo : 극장 정보 불러오기 ajax
	@RequestMapping(value = "/trInfo", method = RequestMethod.POST)
	public @ResponseBody List<THEATER> trInfo(@ModelAttribute THEATER theater) {
		
		List<THEATER> theaterList = trsvc.trInfo(theater);

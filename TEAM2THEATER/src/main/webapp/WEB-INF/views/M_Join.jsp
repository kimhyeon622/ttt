					...
					<div class="col-lg-7">
						<div class="p-5">
							...
							<form class="user" action="mJoin" method="POST" name="joinForm"
								...
								<input type="hidden" name="memTheater1" value="0">
								<input type="hidden" name="memTheater2" value="0">
								...
								<div class="form-group row">
									<div class="col-sm-6 mb-3 mb-sm-0">
										<input type="text" class="form-control form-control-user"
											name="memPhone" placeholder="전화번호" id="memPhone"/>
									</div>
								</div>
	...
	$.ajax({
		...
		success : function(uuid) {
			...
			$("#confEmail").html("<br/><input type='text' id='uuidCheck'/>"
					...
					+" <input type='button' value='인증' style='height: 40px; width: 90px; background-color: red; color:white; border-radius:150px;' onclick=\"checkEmail2()\"/>");
		},
		error : function() {
			alert('이메일 인증 통신 실패!');
		}

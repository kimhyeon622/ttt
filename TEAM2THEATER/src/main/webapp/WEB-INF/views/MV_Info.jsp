    ...
    <section id="schedule">
        <div class="container" data-aos="fade-up">
          ...
          <ul class="nav nav-tabs" role="tablist" data-aos="fade-up" data-aos-delay="100">
            <li class="nav-item">
              <a class="nav-link active" href="#movieInfos" role="tab" data-bs-toggle="tab">주요정보</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#coommeenntt" role="tab" data-bs-toggle="tab">실관람평</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#" role="tab" data-bs-toggle="tab">무비포스트</a>
            </li>
           </ul>
        </div>
        <br/>
        <div id="movieInfos">
            ...
            <!-- 좋아요 버튼 -->
			<button style="width:90px; height:40px;" onclick="movieLike('${loginId}','${movie.mv_Name}')"><span id="movieLikeHeart"></span> <span id="likeNum"></span> </button>
            <br/>
            <hr/>

...
<body>
  ...
  <main id="main">
	<table>
			...
			<tr>
				<th>예매 확인 </th> 
				<td>${list.res_Mvname}</td>
			</tr>	
			</c:forEach>	
				
			<tr>
				<th colspan="2">
					<input type="button" value="수정" onclick="location.href='mModiForm?memId=${view.memId}'"/>
					<input type="button" value="삭제" onclick="location.href='mDelete?memId=${view.memId}'"/>
				</th>
			</tr>
    ...
    <section id="schedule">
        <div class="container" data-aos="fade-up">
          ...
          <ul class="nav nav-tabs" role="tablist" data-aos="fade-up" data-aos-delay="100">
            <li class="nav-item">
              <a class="nav-link active" href="mvAll" role="tab" data-bs-toggle="tab">박스오피스</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="mvCommingsoon" role="tab" data-bs-toggle="tab">상영예정작</a>
            </li>
          </ul>
        </div>
      </section>

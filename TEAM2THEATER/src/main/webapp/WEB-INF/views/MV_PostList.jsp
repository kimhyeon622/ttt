...
<body>
  ...
  <main id="main">
	...
	<tr> 
	<th><a href="mvView?mp_Seq=${blist.mp_Seq}">
		<img src="${pageContext.request.contextPath}/resources/fileUpload/${blist.mp_PosterName}" width="200px"></a></th>
		<th><a href="mvView?mp_Seq=${blist.mp_Seq}">${blist.mp_Mvname}</a></th>
		<th>${blist.mp_Id}</th>
		<th>${blist.mp_Content}</th>
		<th>${blist.mp_Time}</th>
		<th>${blist.mp_Like}</th>
	</tr>
	</c:forEach>
    ...
    <section id="schedule">
        <div class="container" data-aos="fade-up">
          ...
          <ul class="nav nav-tabs" role="tablist" data-aos="fade-up" data-aos-delay="100">
            <li class="nav-item">
              <a class="nav-link" href="mvAll" role="tab" data-bs-toggle="tab">박스오피스</a>
            </li>
            <li class="nav-item">
              <a class="nav-link active" href="mvCommingsoon" role="tab" data-bs-toggle="tab">상영예정작</a>
            </li>
          </ul>
        </div>
      </section>
        ...
        <c:forEach var="list" items="${csList}">
          <div class="col-lg-4 col-md-6">
            <div class="speaker" data-aos="fade-up" data-aos-delay="100">
        		<a><img src="resources/assets/poster/${list.mv_PosterName}" class="img-fluid" width="490" height="500"></a>
             	<div class="details">
                	<h3><a href="mvView?mv_Name=${list.mv_Name}">${list.mv_Name}</a></h3>
